...
export type SelectSlotsAndSlotProps<Multiple extends boolean> = CreateSlotsAndSlotProps<SelectSlots, {
    ...
    } & Omit<PopperOwnProps, 'slots' | 'slotProps' | 'open'>, SelectOwnerState<any, Multiple>>;
}>;
...
export type SelectOwnProps<OptionValue extends {}, Multiple extends boolean> = SelectStaticProps & SelectSlotsAndSlotProps<Multiple> & {
    /**
...
export interface SelectOwnerState<OptionValue extends {}, Multiple extends boolean> extends ApplyColorInversion<SelectOwnProps<OptionValue, Multiple>> {
    /**
...
export interface SelectTypeMap<OptionValue extends {}, Multiple extends boolean = false, P = {}, D extends React.ElementType = 'button'> {
